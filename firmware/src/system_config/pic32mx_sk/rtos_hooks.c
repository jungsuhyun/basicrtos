...
QueueHandle_t xAdcPrintQueue;
QueueHandle_t xKeyPrintQueue;
int keycode;
float bett;
/*
*********************************************************************************************************
...
//extern QueueHandle_t xKeyPrintQueue;
//extern QueueHandle_t xAdcPrintQueue;
...
//    xQueueSendToFrontFromISR(xKeyPrintQueue,&keycode,xHigherPriorityWoken);
//    iCount ++;
//    if(iCount >=300){
//        
//        xQueueSendToFrontFromISR(xAdcPrintQueue,&bett,xHigherPriorityWoken);
//        iCount = 0;
//    }
