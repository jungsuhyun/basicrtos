...
#define QUEUE_SEND_FREQUENCY_MS         ( 500 / portTICK_PERIOD_MS )
...
//    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0,PORT_CHANNEL_D,PORTS_BIT_POS_0);
...
//    PLIB_PORTS_PinToggle(PORTS_ID_0,PORT_CHANNEL_D,PORTS_BIT_POS_0);  
